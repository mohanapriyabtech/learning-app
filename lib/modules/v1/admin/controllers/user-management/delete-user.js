...
var DeleteUserController = /*#__PURE__*/function () {
  function DeleteUserController() {
    (0, _classCallCheck2.default)(this, DeleteUserController);
  }
  ...
  /**
    ...
    * @param {*} res 
    */
  (0, _createClass2.default)(DeleteUserController, [{
    key: "delete",
    value: function () {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _userModel.User.findByIdAndDelete(req.params.id);
            case 3:
              ...
              return _context.abrupt("return", _responseHandler.responseHandler.successResponse(res, result, "User details deleted successfull", 200));
            case 8:
...
var _default = exports.default = new DeleteUserController();
