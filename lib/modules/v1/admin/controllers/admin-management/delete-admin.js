...
var DeleteAdminController = /*#__PURE__*/function () {
  function DeleteAdminController() {
    (0, _classCallCheck2.default)(this, DeleteAdminController);
  }
  ...
  /**
    ...
    * @param {*} res 
    */
  (0, _createClass2.default)(DeleteAdminController, [{
    key: "delete",
    value: function () {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _adminModel.Admin.findByIdAndDelete(req.params.id);
            case 3:
              ...
              return _context.abrupt("return", _responseHandler.responseHandler.successResponse(res, result, "Admin details deleted successfull", 200));
            case 8:
  ...
  return DeleteAdminController;
}();
var _default = exports.default = new DeleteAdminController();
