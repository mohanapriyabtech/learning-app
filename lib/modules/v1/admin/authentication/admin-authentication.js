...
var _sessionModel = require("../models/session-model");
var AdminAuthentication = /*#__PURE__*/function () {
  function AdminAuthentication() {
    (0, _classCallCheck2.default)(this, AdminAuthentication);
    ...
    _passport.default.use('admin-jwt', new _passportJwt.Strategy(opts, /*#__PURE__*/function () {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _adminModel.Admin.findById(jwtPayload.id);
            case 3:
              user = _context.sent;
              if (!user) {
                _context.next = 8;
  ...
  (0, _createClass2.default)(AdminAuthentication, [{
    key: "check",
    value: function () {
...
var _default = exports.default = new AdminAuthentication();
//# sourceMappingURL=admin-authentication.js.map